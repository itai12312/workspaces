...
public class app {
    ...
    public static ByteBuffer    tmpInt = allocBytes(4); // temp var used by getPixelColor()
     ...
     */
    public void update() {
    	Display.setTitle("FPS: " + getFramesPerSecond());
    }
	...
	*/
    ...
    public static Class rootClass = app.class;
