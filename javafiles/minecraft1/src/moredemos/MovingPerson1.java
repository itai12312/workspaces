...
public class MovingPerson1{
	...
	double xperson=/*Display.getHeight()/2*/ -5.0;
	double yperson=/*Display.getWidth()/2*/ 0.1;	
	public void run(){
	...
	private void renderGL() {
		...
		System.out.println(xperson+" "+yperson);
		...
		for(float t=-640;t<640;t++){
			for(float t1=-480;t1<480;t1++){
				...
				//GL11.glVertex3d(t,  t1,z(t/scale,t1/scale));
				//GL11.glVertex3d(t+1, t1,z((t+1)/scale,t1/scale) );
				//GL11.glVertex3d(t+1,t1+1,z((t+1)/scale,(t1+1)/scale) );
				//GL11.glVertex3d(t, t1+1,z(t/scale,(t1+1)/scale) );
		...
		GL11.glPushMatrix();
		GL11.glBegin(GL11.GL_QUADS);
		GL11.glColor3d(0.2, 0.5, 0.7);
		GL11.glVertex3d(xperson, z(xperson/scale,yperson/scale), yperson);
		GL11.glVertex3d(xperson+1, z((xperson+1)/scale,yperson/scale), yperson);
		GL11.glVertex3d(xperson+1, z((xperson+1)/scale,(yperson+1)/scale),yperson+1 );
		GL11.glVertex3d(xperson,z(xperson/scale,(yperson+1)/scale), yperson+1 );
	...
	public static void main(String[] args) {
		MovingPerson1 cubedemo= new MovingPerson1();
		cubedemo.run();
