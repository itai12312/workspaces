...
public class ServerTextArea extends JPanel{
	...
	private MultiThreadServer multi=null;
	...
	private class p extends JPanel implements KeyListener,MouseListener,MouseMotionListener,MouseWheelListener{
		...
		public void mouseWheelMoved(MouseWheelEvent e) {
			...
			multi.sendToAll(e.getClickCount()+","+e.getButton()+",whemm"+e.getButton());
		}
		public void mouseDragged(MouseEvent arg0) {
			frame.setTitle("mouseDragged");
			multi.sendToAll(arg0.getXOnScreen()+","+arg0.getYOnScreen()+"dragg"+arg0.getButton());
		}
		public void mouseMoved(MouseEvent arg0) {
			frame.setTitle("mouseMoved");
			multi.sendToAll(arg0.getXOnScreen()+","+arg0.getYOnScreen()+"moved"+arg0.getButton());
		}
	}
}
