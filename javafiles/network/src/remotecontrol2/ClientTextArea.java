...
public class ClientTextArea extends JPanel{
	...
	JFrame frame = new JFrame("Server1");
	...
	public ClientTextArea(MultiThreadServer multi) {
		super();
		this.multi=multi;
	...
	protected void send(String text,int port,String host) {
		write("send at time:"+new Timestamp(new java.util.Date().getTime()));
	...
	public static void main(String[]args) {
        ...
        //Create and set up the content pane.
        JComponent newContentPane = new ClientTextArea(mu);
        newContentPane.setOpaque(true); //content panes must be opaque
        frame.setContentPane(newContentPane);
        ...
        frame.pack();
        frame.setVisible(true);*/
		ClientTextArea d=new ClientTextArea(null);
	}
